...
const resumeData = {
  ...
  summary: "Pre-final year Electronics & Computer Science student at KIIT (2027) with a track record in content strategy, community growth, and data storytelling. Founder of Sahitya Rachanalu — a Telugu literary community built from scratch. Passionate about sports analytics with hands-on projects in IPL and cricket data.",
  education: {
  ...
  projects: [
    {
      ...
      skills_demonstrated: ["SQL-style data wrangling", "Python/Pandas", "Data Visualization", "Sports Domain Knowledge"],
    },
    {
      id: "bpl",
      ...
      bullets: [
        ...
        "Focus: player valuation, form analysis, overseas vs local player impact",
      ],
      skills_demonstrated: ["Cross-dataset analysis", "Benchmarking", "Sports domain depth"],
    },
    {
      id: "ecom",
      ...
      bullets: [
        ...
        "Focus: cohort retention, growth metrics, and product performance KPIs",
      ],
      skills_demonstrated: ["Funnel Analysis", "SQL", "Growth Metrics", "Business Analyst thinking"],
    },
    {
      id: "ott",
      ...
      bullets: [
        ...
        "Product lens: feature adoption, user journey mapping, retention KPIs",
      ],
      skills_demonstrated: ["Content Analytics", "Product Thinking", "Retention Metrics", "Churn Modeling"],
    },
    {
      id: "hiremap",
      ...
      skills_demonstrated: ["Frontend Dev", "Product Thinking", "Deployment (Vercel)", "Collaboration"],
    },
    {
      id: "sahitya",
  ...
  skills: {
    current: ["Python (basics)", "Pandas", "Matplotlib", "React", "TypeScript", "HTML/CSS", "Git/GitHub", "SEO Writing", "Content Strategy", "Figma (basic)", "MS Excel"],
    learning: ["SQL", "Power BI / Tableau", "Google Analytics", "Advanced Pandas", "A/B Testing basics", "Product Metrics (DAU, MAU, Retention, LTV)"],
    planned: ["dbt (data build tool)", "Looker / Metabase", "Amplitude / Mixpanel", "Python for Finance (yfinance)", "Cohort Analysis", "Statistical Hypothesis Testing"],
  },
};
...
function ResumeATSAnalyzer() {
  ...
  const allCurrentSkills = new Set(resumeData.skills.current.map(s => s.toLowerCase()));
  const allLearningSkills = new Set(resumeData.skills.learning.map(s => s.toLowerCase()));
      ...
      <div style={{ background: "#050508", borderBottom: "1px solid #1E293B", padding: "32px 40px 0" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 20, marginBottom: 24 }}>
            <div>
              <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 42, letterSpacing: 4, color: "#F8FAFC", lineHeight: 1 }}>{resumeData.name}</div>
              <div style={{ fontSize: 11, letterSpacing: 3, color: "#64748B", textTransform: "uppercase", marginTop: 6 }}>{resumeData.title}</div>
              <div style={{ display: "flex", gap: 16, marginTop: 12, flexWrap: "wrap" }}>
                {Object.entries(resumeData.contact).map(([k, v]) => (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 320px", gap: 32 }}>
            <div>
              <div style={{ marginBottom: 32 }}>
                ...
                <p style={{ fontSize: 12, lineHeight: 1.8, color: "#94A3B8" }}>{resumeData.summary}</p>
              </div>
            ...
            <div>
              <div style={{ marginBottom: 28 }}>
                ...
                <div style={{ fontSize: 12, color: "#F1F5F9", fontWeight: 600, marginBottom: 4 }}>{resumeData.education.degree}</div>
                <div style={{ fontSize: 11, color: "#64748B", lineHeight: 1.8 }}>
                  {resumeData.education.college}<br />
                  {resumeData.education.year}<br />
                  <span style={{ color: "#475569" }}>CGPA: </span>{resumeData.education.cgpa}
                </div>
              </div>
              ...
              <div style={{ marginBottom: 28 }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                  {resumeData.skills.current.map(s => (
              ...
              <div style={{ marginBottom: 28 }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                  {resumeData.skills.learning.map(s => (
              ...
              <div>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                  {resumeData.skills.planned.map(s => (
