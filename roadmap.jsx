...
const weeks = [
    ...
    "days": [
      {
        ...
        "tasks": [
          ...
          { "time": "10\u201311am", "task": "\ud83e\udde0 Aptitude: Quant: Number System (Part 1) + Mock 1", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/quantitative-aptitude/numbers/basic?subject=quantitative-aptitude&sidebar=open" },
      ...
      },
      {
        ...
        "tasks": [
          ...
          { "time": "10\u201311am", "task": "\ud83e\udde0 Aptitude: Quant: Number System (Part 2) + Mock 2", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/quantitative-aptitude/numbers/basic?subject=quantitative-aptitude&sidebar=open" },
      ...
      },
      {
        ...
        "tasks": [
          ...
          { "time": "10\u201311am", "task": "\ud83e\udde0 Aptitude: Quant: LCM & HCF (Part 1) + Mock 3", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/quantitative-aptitude/numbers/basic?subject=quantitative-aptitude&sidebar=open" },
      ...
      },
      {
        ...
        "tasks": [
          ...
          { "time": "10\u201311am", "task": "\ud83e\udde0 Aptitude: Quant: LCM & HCF (Part 2) + Mock 4", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/quantitative-aptitude/numbers/basic?subject=quantitative-aptitude&sidebar=open" },
      ...
      },
      {
        ...
        "tasks": [
          ...
          { "time": "10\u201311am", "task": "\ud83e\udde0 Aptitude: Quant: Percentages (Part 1) + Mock 5", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/quantitative-aptitude/percentages/basic?subject=quantitative-aptitude&sidebar=open" },
      ...
      },
      {
        ...
        "tasks": [
          ...
          { "time": "10\u201311am", "task": "\ud83e\udde0 Aptitude: Quant: Percentages (Part 2) + Mock 6", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/quantitative-aptitude/percentages/basic?subject=quantitative-aptitude&sidebar=open" },
      ...
      },
      {
        ...
        "tasks": [
          ...
          { "time": "10\u201311am", "task": "\ud83e\udde0 Aptitude: Quant: Profit & Loss (Part 1) + Mock 7", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/quantitative-aptitude/profit-and-loss/basic?subject=quantitative-aptitude&sidebar=open" },
  ...
  },
  {
    ...
    "color": BLUE,
    "days": [
      { "day": 8, "title": "Day 8: IPL Layer 1: Sports Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Profit & Loss (Part 2) + Mock 8", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/quantitative-aptitude/profit-and-loss/basic?subject=quantitative-aptitude&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Project: IPL Layer 1: Sports Analyst (On-Field Intelligence)", "type": "project" }], "outcome": "Mastered player ROI & win probability metrics." },
      { "day": 9, "title": "Day 9: IPL Layer 2: Product Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: SI & CI (Part 1) + Mock 9", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: IPL Layer 2: Product Analyst (User Engagement)", "type": "project" }], "outcome": "Analyzed match moments vs concurrency spikes." },
      { "day": 10, "title": "Day 10: IPL Layer 3: Business Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: SI & CI (Part 2) + Mock 10", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: IPL Layer 3: Business Analyst (Revenue & ROI)", "type": "project" }], "outcome": "Completed franchise valuation & sponsorship analysis." },
      { "day": 11, "title": "Day 11: IPL Layer 4: Growth Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Averages (Part 1) + Mock 11", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: IPL Layer 4: Growth Analyst (Marketing & Virality)", "type": "project" }], "outcome": "Mapped social media trend velocity vs match events." },
      { "day": 12, "title": "Day 12: IPL Layer 5: Strategy Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Averages (Part 2) + Mock 12", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: IPL Layer 5: Strategy Analyst (Macro Industry Impact)", "type": "project" }], "outcome": "Completed 5-layer industry shift analysis." },
      { "day": 13, "title": "Day 13: IPL Full-Stack Dashboard", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Ratio & Proportion (Part 1) + Mock 13", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: IPL Integrated Multi-Role Dashboard Build", "type": "project" }], "outcome": "Live dashboard covering all 5 roles complete." },
      { "day": 14, "title": "Day 14: IPL Strategy Report", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Ratio & Proportion (Part 2) + Mock 14", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: IPL Consulting Report (McKinsey Style)", "type": "project" }], "outcome": "Project 1 finished with 7-role framework." }
    ]
  },
  {
    "week": 3,
    ...
    "color": PURPLE,
    "days": [
      { "day": 15, "title": "Day 15: OTT Layer 1: Data Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Mixtures & Alligations (Part 1) + Mock 15", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: OTT Layer 1: Data Analyst (Genre & Revenue)", "type": "project" }] },
      { "day": 16, "title": "Day 16: OTT Layer 2: Product Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Mixtures & Alligations (Part 2) + Mock 16", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: OTT Layer 2: Product Analyst (Sentiment & Booking)", "type": "project" }] },
      { "day": 17, "title": "Day 17: OTT Layer 3: Business Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Time & Work (Part 1) + Mock 17", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: OTT Layer 3: Business Analyst (Multiplex vs Single)", "type": "project" }] },
      { "day": 18, "title": "Day 18: OTT Layer 4: Growth Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Time & Work (Part 2) + Mock 18", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: OTT Layer 4: Growth Analyst (Marketing ROI)", "type": "project" }] },
      { "day": 19, "title": "Day 19: OTT Layer 5: Strategy Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Speed, Dist & Time (Part 1) + Mock 19", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: OTT Layer 5: Strategy Analyst (Lifecycle & COVID)", "type": "project" }] },
      { "day": 20, "title": "Day 20: OTT Dashboard", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Speed, Dist & Time (Part 2) + Mock 20", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: OTT Multi-Domain Tableau Storyboard", "type": "project" }] },
      { "day": 21, "title": "Day 21: OTT Final Case Study", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Permutation & Probability + Mock 21", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: OTT Financial & Strategy Whitepaper", "type": "project" }] }
    ]
  },
  {
    "week": 4,
    ...
    "color": GREEN,
    "days": [
      { "day": 22, "title": "Day 22: E-com Layer 1: Data Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: LR: Series (Part 1) + Mock 22", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/logical-reasoning/series-missing-numbers-odd-one-out/basic?subject=logical-reasoning&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Project: E-com Layer 1: Data Analyst (Seasonal Sales)", "type": "project" }] },
      { "day": 23, "title": "Day 23: E-com Layer 2: Business Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: LR: Series (Part 2) + Mock 23", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/logical-reasoning/series-missing-numbers-odd-one-out/basic?subject=logical-reasoning&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Project: E-com Layer 2: Business Analyst (Pricing & Anchoring)", "type": "project" }] },
      { "day": 24, "title": "Day 24: E-com Layer 3: Growth Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: LR: Blood Relations (Part 1) + Mock 24", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: E-com Layer 3: Growth Analyst (Ads & Attribution)", "type": "project" }] },
      { "day": 25, "title": "Day 25: E-com Layer 4: Product Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: LR: Blood Relations (Part 2) + Mock 25", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: E-com Layer 4: Product Analyst (Consumer Psych Funnel)", "type": "project" }] },
      { "day": 26, "title": "Day 26: E-com Layer 5: Financial Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: LR: Coding-Decoding (Part 1) + Mock 26", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: E-com Layer 5: Financial Analyst (Unit Economics & LTV)", "type": "project" }] },
      { "day": 27, "title": "Day 27: E-com Layer 6: Strategy Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: LR: Coding-Decoding (Part 2) + Mock 27", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: E-com Layer 6: Strategy Analyst (Market Shifts)", "type": "project" }] },
      { "day": 28, "title": "Day 28: E-com Layer 7: Business Analyst", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: LR: Syllogisms (Part 1) + Mock 28", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Project: E-com Layer 7: Business Analyst (Conglomerates)", "type": "project" }] }
    ]
  },
  {
    "week": 5,
    ...
    "color": ACCENT,
    "days": [
      { "day": 29, "title": "Day 29: BPL Layer 1 & 2: Market & Demand", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Verbal: Passage (Part 1) + Mock 29", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/verbal-ability/passage-sentence-rearrangement/basic?subject=verbal-ability&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Project: BPL Layer 1 (Market) & Layer 2 (Demand) Analysis", "type": "project" }], "outcome": "Mapped Hyderabad venue density & traffic." },
      { "day": 30, "title": "Day 30: BPL Layer 3 & 4: Supply & Matchmaking", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Verbal: Passage (Part 2) + Mock 30", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/verbal-ability/passage-sentence-rearrangement/basic?subject=verbal-ability&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Project: BPL Layer 3 (Bands) & Layer 4 (Optimization) Build", "type": "project" }], "outcome": "Built scheduling & slot optimization model." },
      { "day": 31, "title": "Day 31: BPL Layer 5 & 6: Revenue & Funnel", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Verbal: Sentence Rearrangement (Part 1) + Mock 31", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/verbal-ability/passage-sentence-rearrangement/basic?subject=verbal-ability&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Project: BPL Layer 5 (Revenue) & Layer 6 (Booking Funnel)", "type": "project" }], "outcome": "Completed pricing strategy & drop-off analysis." },
      { "day": 32, "title": "Day 32: BPL Layer 7 & 8: Growth & Ecosystem", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Verbal: Sentence Rearrangement (Part 2) + Mock 32", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/verbal-ability/passage-sentence-rearrangement/basic?subject=verbal-ability&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Project: BPL Layer 7 (Growth) & Layer 8 (Macro Impact)", "type": "project" }], "outcome": "Economic impact model & growth curves complete." },
      { "day": 33, "title": "Day 33: BPL Dashboard Build", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: LR: Missing Numbers + Mock 33", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/logical-reasoning/series-missing-numbers-odd-one-out/basic?subject=logical-reasoning&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Project: BPL Interactive Matchmaking Dashboard", "type": "project" }], "outcome": "Live analytics portal for venue/bands." },
      { "day": 34, "title": "Day 34: BPL Economic Report", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: LR: Odd One Out + Mock 34", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/logical-reasoning/series-missing-numbers-odd-one-out/basic?subject=logical-reasoning&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Project: BPL 15-page Primary Data Deep-Dive", "type": "project" }], "outcome": "Finished professional industry report." },
      { "day": 35, "title": "Day 35: BPL Launch & Pitch", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: LR: Advanced Series + Mock 35", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/logical-reasoning/series-missing-numbers-odd-one-out/basic?subject=logical-reasoning&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Strategy: BPL LinkedIn Viral Breakdown", "type": "project" }], "outcome": "Primary data project live & shared." }
    ]
  },
  {
    "week": 6,
    ...
    "color": BLUE,
    "days": [
      { "day": 36, "title": "Day 36: Portfolio UI", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Advanced Numbers (Part 1) + Mock 36", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/quantitative-aptitude/numbers/basic?subject=quantitative-aptitude&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Portfolio: Hero & Architecture Build", "type": "project" }] },
      { "day": 37, "title": "Day 37: Portfolio Projects", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Advanced Numbers (Part 2) + Mock 37", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/quantitative-aptitude/numbers/basic?subject=quantitative-aptitude&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Portfolio: 4-Project Hub Integration", "type": "project" }] },
      { "day": 38, "title": "Day 38: Portfolio Proof", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Unit Digit & Remainder + Mock 38", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/quantitative-aptitude/numbers/basic?subject=quantitative-aptitude&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Portfolio: Skill Viz & Proof Build", "type": "project" }] },
      { "day": 39, "title": "Day 39: Portfolio Content", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Divisibility Rules + Mock 39", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/quantitative-aptitude/numbers/basic?subject=quantitative-aptitude&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Portfolio: Sahitya Hub Integration", "type": "project" }] },
      { "day": 40, "title": "Day 40: Portfolio Resume", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Quant: Factorials & Trailing Zeros + Mock 40", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/quantitative-aptitude/numbers/basic?subject=quantitative-aptitude&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Portfolio: Resume Downloads Build", "type": "project" }] },
      { "day": 41, "title": "Day 41: Portfolio SEO", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: LR: Mixed Series (Part 1) + Mock 41", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/logical-reasoning/series-missing-numbers-odd-one-out/basic?subject=logical-reasoning&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Portfolio: Analytics & SEO Setup", "type": "project" }] },
      { "day": 42, "title": "Day 42: Portfolio Launch", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: LR: Mixed Series (Part 2) + Mock 42", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/logical-reasoning/series-missing-numbers-odd-one-out/basic?subject=logical-reasoning&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Branding: LinkedIn Grand Reveal", "type": "project" }] }
    ]
  },
  {
    "week": 7,
    ...
    "color": PURPLE,
    "days": [
      { "day": 43, "title": "Day 43: Sahitya Reading", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Verbal: Passage (Part 1) + Mock 43", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/verbal-ability/passage-sentence-rearrangement/basic?subject=verbal-ability&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Sahitya: Reading Module Build", "type": "project" }] },
      { "day": 44, "title": "Day 44: Sahitya Lyrics", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Verbal: Passage (Part 2) + Mock 44", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/verbal-ability/passage-sentence-rearrangement/basic?subject=verbal-ability&sidebar=open" }, { "time": "1\u20136pm", "task": "\ud83c\udfd7\ufe0f Sahitya: Lyrics Split-View Build", "type": "project" }] },
      { "day": 45, "title": "Day 45: Sahitya Cinepedia", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Verbal: Sentence Rearrangement (Part 1) + Mock 45", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/verbal-ability/passage-sentence-rearrangement/basic?subject=verbal-ability&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Sahitya: Film Wiki UI Build", "type": "project" }] },
      { "day": 46, "title": "Day 46: Sahitya Fictionary", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Verbal: Sentence Rearrangement (Part 2) + Mock 46", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/verbal-ability/passage-sentence-rearrangement/basic?subject=verbal-ability&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Sahitya: Dialogue Card Build", "type": "project" }] },
      { "day": 47, "title": "Day 47: Sahitya Media", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: LR: Missing Numbers + Mock 47", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/logical-reasoning/series-missing-numbers-odd-one-out/basic?subject=logical-reasoning&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Sahitya: Meme/GIF Keyboard Build", "type": "project" }] },
      { "day": 48, "title": "Day 48: Sahitya Content", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: LR: Odd One Out + Mock 48", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/logical-reasoning/series-missing-numbers-odd-one-out/basic?subject=logical-reasoning&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Sahitya: MDX Article Feed Build", "type": "project" }] },
      { "day": 49, "title": "Day 49: Sahitya Launch", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: LR: Missing Numbers (Advanced) + Mock 49", "type": "aptitude", "link": "https://takeuforward.org/plus/aptitude/logical-reasoning/series-missing-numbers-odd-one-out/basic?subject=logical-reasoning&sidebar=open" }, { "time": "1\u20136pm", "task": "🏗️ Branding: Founder Reveal Day", "type": "project" }] }
    ]
  },
  {
    "week": 8,
    ...
    "color": GREEN,
    "days": [
      { "day": 50, "title": "Day 50: Advanced Upgrades", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Mock 50", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Upgrade: IPL/OTT/E-com ML & NLP Predictive Build", "type": "project" }] },
      { "day": 51, "title": "Day 51: Advanced Pipelines", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Mock 51", "type": "aptitude" }, { "time": "1\u20136pm", "task": "📊 AnalystBuilder: Snowflake/DBT Advanced Build", "type": "analytics" }] },
      { "day": 52, "title": "Day 52: Showcase & Target Research", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Mock 52", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Strategy: Journey Showcase & Company Reports Build", "type": "project" }] },
      { "day": 53, "title": "Day 53: Technical Mock Interviews", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Mock 53", "type": "aptitude" }, { "time": "1\u20136pm", "task": "📊 Practice: SQL & Technical Mock Sprints", "type": "analytics" }] },
      { "day": 54, "title": "Day 54: Business Case Sprints", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Mock 54", "type": "aptitude" }, { "time": "1\u20136pm", "task": "📊 Practice: Case Interview & Strategy Sprints", "type": "analytics" }] },
      { "day": 55, "title": "Day 55: High-Intent Application Blitz", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Mock 55", "type": "aptitude" }, { "time": "9am\u20136pm", "task": "🏗️ Strategy: 20+ High-Intent Applications", "type": "project" }] },
      { "day": 56, "title": "Day 56: Maintenance & QA", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Mock 56", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Polish: Full System Bug fixing & QA", "type": "project" }] },
      { "day": 57, "title": "Day 57: Referral & Networking", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Mock 57", "type": "aptitude" }, { "time": "9am\u20136pm", "task": "🏗️ Strategy: Referral Outreach Blitz", "type": "project" }] },
      { "day": 58, "title": "Day 58: Catch-up & Final Polish", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Mock 58", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Catch-up on backlog & Resume Metric Polish", "type": "project" }] },
      { "day": 59, "title": "Day 59: Final Deployment", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Mock 59", "type": "aptitude" }, { "time": "1\u20136pm", "task": "🏗️ Final Vercel & Production Sync", "type": "project" }] },
      { "day": 60, "title": "Day 60: Hired Mindset Day", "tasks": [{ "time": "9am\u201310am", "task": "\ud83e\udde0 Aptitude: Mock 60", "type": "aptitude" }, { "time": "9am\u201312pm", "task": "🎉 Goal: Reflection & Career Launch", "type": "project" }] }
    ]
  }
];
