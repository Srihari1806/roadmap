    ...
    deliverables: [
{
  ...
  },
  {
    ...
    roleMap: [
      ...
      { section: "Onboarding Funnel", role: "Product Analyst" },
  ...
  },
  {
    ...
    layers: [
      ...
      {
        num: "3", icon: "🎮", title: "Interaction & Gamification",
        role: "Product Analyst",
    ...
    roleMap: [
      { section: "SEO & Content", role: "Content Strategist" },
      { section: "Story Universe", role: "Narrative Designer" },
      { section: "Gamification", role: "Product Analyst" }
    ]
  }
];
          ...
          <div style={{ display: "flex", gap: 0, borderBottom: "1px solid #1E293B" }}>
            {["resume", "ats-gap", "roadmap", "assessment"].map(tab => (
              <button key={tab} onClick={() => setActiveTab(tab)} className={`tab-btn ${activeTab === tab ? "active" : "inactive"}`}>
                {tab === "resume" ? "📄 Resume" : tab === "ats-gap" ? "🎯 ATS Gap Analysis" : tab === "roadmap" ? "🗺 Skill Roadmap" : "📋 Role Assessment"}
              </button>
            ))}
          </div>
        </div>
